...
public class WPTree implements WordPath {
	...
	public List<String> findPath(String word1, String word2) 
	{
		...
		List<WPTreeNode> q1=new LinkedList<WPTreeNode>();
		...
		int t=0;
		while((!q1.isEmpty() || 	! curr.getWord().equals(word2)))	
		{
		//	System.out.println("ans\n");
		curr=q1.remove(0);
		System.out.println("ans"+curr.getWord());
		List<String> near=new ArrayList<String>();
		near=nw.distanceOne(curr.getWord(),true);
		...
		for(String ss:near)
		{
			...
			//	System.out.println("ans33");
				if(ss.equals(word2)){
					WPTreeNode p=new WPTreeNode(ss,curr);
					return p.buildPathToRoot();
				}
			}
		}
		
		List<WPTreeNode> x=new LinkedList<WPTreeNode>();
