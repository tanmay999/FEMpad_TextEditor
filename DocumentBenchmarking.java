...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String fil=getStringFromFile(textfile,numToCheck);
			double startTime1=System.nanoTime();
			for(int i=0;i<trials;i++)
			{
			Document ob1=new BasicDocument(fil);
				...
				double f1=(stopTime1-startTime1)/1000000000;
				System.out.print(f1+"\t");
				double startTime2=System.nanoTime();
				for(int i=0;i<trials;i++)
				{
				Document ob2=new EfficientDocument(fil);
			
				
				
				double ef=ob2.getFleschScore();
				
				}
				double stopTime2=System.nanoTime();
				double f2=(stopTime2-startTime2)/1000000000;
