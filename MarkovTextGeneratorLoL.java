...
public class MarkovTextGeneratorLoL implements MarkovTextGenerator {
	...
	public void train(String sourceText)
	{
		...
		{
			String src[]=sourceText.split("[ ,.]+");
			String starter=src[0];
	...
	public  ListNode find(String wa)
	{
		for(ListNode b:wordList)
		{
			if(wa.equals(b.getWord()))
			{
				return b;
			}
	...
	public static void main(String[] args)
	{
		...
		System.out.println(gen);
		//System.out.println("the generated text is as folows::\n");
...
class ListNode
{
	...
	public String getRandomNextWord(Random generator)
	{
		...
		int s=nextWords.size();
		int f=generator.nextInt(s);
		return nextWords.get(f);
